    ...
    @section('content')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success text-light" onclick="finalizeEvent()" data-dismiss="modal">Finalizar <i class="bi bi-check2-circle"></i></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var events = {!! json_encode(
                    $eventos->map(function ($evento) {
                        return [
                            'id' => $evento->id,  // Assegurando que o ID do evento está sendo passado
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventClick: function(info) {
                        ...
                        console.log("Evento ID:", info.event.id); // Verifica se o ID está sendo capturado corretamente
            ...
            function finalizeEvent() {
                ...
                console.log("Finalizando evento com ID:", atendimentoId); // Verifica o ID antes de enviar a requisição
